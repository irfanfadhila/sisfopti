...
/**
 * This is the model class for table "SisfoPTI.server_penelitian".
 *
 * The followings are the available columns in table 'SisfoPTI.server_penelitian':
 ...
 */
class ServerPenelitianForm extends CActiveRecord
{
	/**
	...
	{
		return 'SisfoPTI.server_penelitian';
	}
	...
	public function rules()
	{
		...
		return array(
			array('id_service_request, size, pembimbing', 'required'),
			...
			array('id_service_request, size, pembimbing', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ServerPenelitianForm the static model class
	 */
