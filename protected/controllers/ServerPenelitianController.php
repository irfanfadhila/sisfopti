...
class ServerPenelitianController extends Controller
{
	/**
	...
	public function actionCreate()
	{
        ...
        $nameserv= NamaService::model()->findByAttributes(array('id_nama_service'=>4));
		...
		if(isset($_POST['ServerPenelitian'], $_POST['ServiceRequest']))
		{
			$model->attributes=$_POST['ServerPenelitian'];
	...
	{
		$dataProvider=new CActiveDataProvider('ServerPenelitian');
	...
	{
		$model=new ServerPenelitian('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ServerPenelitian']))
			$model->attributes=$_GET['ServerPenelitian'];
	 ...
	 * @return ServerPenelitian the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=ServerPenelitian::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param ServerPenelitian $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='server-penelitian-form')
		{
