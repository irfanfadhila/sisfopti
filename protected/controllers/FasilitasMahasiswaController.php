...
class FasilitasMahasiswaController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('FasilitasMahasiswa');
	...
	{
		$model=new FasilitasMahasiswa('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['FasilitasMahasiswa']))
			$model->attributes=$_GET['FasilitasMahasiswa'];
	 ...
	 * @return FasilitasMahasiswa the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=FasilitasMahasiswa::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param FasilitasMahasiswa $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='fasilitas-mahasiswa-form')
		{
